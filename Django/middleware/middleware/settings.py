...
SECRET_KEY = 'django-insecure-@dg()@t0ek8xdv%qayp^lc$7nixw5+qg!2wf!meeh04^6s8!au'
...
MIDDLEWARE = [
    ...
    # 'app.middlewares.MyMiddleware_C',
     'app.middlewares.HooksMiddleware',
...
DATABASES = {
    'default': {
        ...
        'NAME': 'middleware',# Change db_name with desired database name
        'USER': 'root',
        'PASSWORD': 'root',
        'HOST': 'localhost',
        'PORT': '3306',
